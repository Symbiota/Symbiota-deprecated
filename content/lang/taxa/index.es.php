...
$LANG['AMB_ACCEPTED'] = 'This name is accepted, but is also synonymized with the follwoing taxa: ';
$LANG['AMB_UNACCEPTED'] = 'This name is not accepted, but is synonymized with the follwoing taxa: ';
