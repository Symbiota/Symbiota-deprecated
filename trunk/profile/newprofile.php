			...
			<div style="margin:15px;">
				<table cellspacing='3'>
					<tr>
						...
						<td>
							<input name="username" value="<?php echo $username; ?>" size="20" />
							<br/>&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							<input name="pwd" id="pwd" value="<?php echo $pwd; ?>" size="20" type="password" /><br/>
						</td> 
					</tr>
					<tr>
						<td>
						...
						<td>
							<input id="pwd2" name="pwd2" value="<?php echo $pwd; ?>" size="20" type="password" />
							<br/>&nbsp;
						</td> 
					</tr>
					<tr>
