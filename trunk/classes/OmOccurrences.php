...
// Up to date with schema version 0.9.1.13
...
class OmOccurrences  {
 ...
 public function checkSchema() {
        ...
        if ($statement = $connection->prepare($preparesql)) {
            ...
            $statement->fetch();
            // no changes between version 0.9.1.12 and 0.9.1.13, so this class is compatible with both.
            if ($versionnumber=='0.9.1.12' || $versionnumber=='0.9.1.13') {
               $result = true;
            } 
       }
       return $result;
