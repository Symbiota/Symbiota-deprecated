...
<div id="innertext">
	...
	if($editable){
		...
		<div>
			Feed: <a href="../../webservices/dwc/rss.xml"></a>
		</div>
		<?php
		...
		<form name="dwcaform" action="datapublisher.php" method="post">
			<fieldset style="padding:15px;">
				<legend>Publish / Refresh DWCA File</legend>
				<!-- 
				<div>
					<?php 
				...
				-->
				<div>
					<input type="checkbox" name="dets" value="1" /> Include Determination History<br/>
					<input type="checkbox" name="imgs" value="1" /> Include Image URLs<br/>
					<input type="checkbox" name="redact" value="1" /> Redact Sensitive Localities<br/>
					<!-- 
					<input type="radio" name="schema" value="1" /> Darwin Core Archive<br/>
