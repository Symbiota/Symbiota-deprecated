...
class DownloadManager extends CollectionManager{
	...
	//private $fileName = "";
 	...
 	public function __construct(){
 		parent::__construct();
 		//$timestamp = time();
		//$this->downloadPath .= "/downloads/seinetdata_".$timestamp; 
		//$this->downloadUrl .= "/downloads/seinetdata_".$timestamp;
		...
		if(array_key_exists("spprid",$this->searchTermsArr)) $this->dwcSql .= "INNER JOIN omoccurprojlink spl ON o.occurrenceID = spl.guid ";
