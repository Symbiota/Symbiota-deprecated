			...
			<fieldset>
				...
				<div style="padding-bottom:2px;">
					...
					<span style="float:right;">
						<b>Loan Identifier: </b><input type="text" autocomplete="off" name="loanidentifierown" maxlength="255" style="width:120px;border:2px solid black;text-align:center;font-weight:bold;color:black;" value="<?php echo $identifierOut; ?>" />
					</span>
				</div>
