		        ...
		        <div class="fieldset" style="margin:30px 0px 10px 10px;">
					...
					<?php if($isAdmin || in_array("TaxonProfile",$userRights)){?>
            			<ul>
							...
							<li><a href="taxa/admin/tpeditor.php?taxon=&category=textdescr">Text Descriptions</a></li>
							<li><a href="taxa/admin/tpeditor.php?taxon=&category=images">Edit Images</a></li>
							<ul>
								<li><a href="taxa/admin/tpeditor.php?taxon=&category=imagequicksort">Edit Image Sorting Order</a></li>
								<li><a href="taxa/admin/tpeditor.php?taxon=&category=imageadd">Add a New Image</a></li>
							</ul>
            			</ul>
	            	<?php 
						}
