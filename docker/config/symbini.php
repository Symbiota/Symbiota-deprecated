...
$DEFAULT_PROJ_ID = 1;
$DEFAULTCATID = 0;
$DEFAULT_TITLE = 'OregonFlora';
$TID_FOCUS = '';
$ADMIN_EMAIL = 'noreply@oregonflora.org';
$CHARSET = 'UTF-8';					//ISO-8859-1 or UTF-8
$PORTAL_GUID = '0';				//Typically a UUID
$SECURITY_KEY = '0';				//Typically a UUID used to verify access to certain web service

$CLIENT_ROOT = '/';				//URL path to project root folder (relative path w/o domain, e.g. '/seinet')
$SERVER_ROOT = '/app';				//Full path to Symbiota project root folder
