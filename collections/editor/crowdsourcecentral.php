		...
		<div style="margin:20px;clear:both;">
			...
			<table class="styledtable">
				...
				foreach($userStats as $collId => $sArr){
					...
					echo '<td><a href="occurrencetabledisplay.php?csmode=1&occindex=0&displayquery=1&reset=1&collid='.$collId.'" target="_blank">'.(array_key_exists(0,$cArr)?$cArr[0]:0).'</a></td>';
					echo '</tr>';
				}
				?>
			</table>
