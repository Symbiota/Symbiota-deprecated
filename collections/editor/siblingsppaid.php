...
<head>
	...
	<script type="text/javascript">
		...
		function addName(){
		    ...
		    if(nameElem.value){
		    	var asStr = opener.document.fullform.siblingTaxaLexiconIndigenous.value;
		    	if(asStr) asStr = asStr + ", ";  
		    	opener.document.fullform.siblingTaxaLexiconIndigenous.value = asStr + nameElem.value;
		    	nameElem.value = "";
		    	nameElem.focus();
		    }
	    }
...
<body style="background-color:white">
	...
	<div id="innertext" style="background-color:white;">
		<fieldset style="width:450px;">
			<legend><b>Sibling Species Entry Aid</b></legend>
			<div style="">
				Taxon: 
