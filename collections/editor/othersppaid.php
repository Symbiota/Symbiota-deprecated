...
<head>
	...
	<title>Others Species Entry Aid</title>
	...
	<script type="text/javascript">
		...
		function addName(){
		    ...
		    if(nameElem.value){
		    	var asStr = opener.document.fullform.otherTaxaUseIndigenous.value;
		    	if(asStr) asStr = asStr + ", ";  
		    	opener.document.fullform.otherTaxaUseIndigenous.value = asStr + nameElem.value;
		    	nameElem.value = "";
		    	nameElem.focus();
		    }
	    }
...
<body style="background-color:white">
	...
	<div id="innertext" style="background-color:white;">
		<fieldset style="width:450px;">
			<legend><b>Other Species Entry Aid</b></legend>
			<div style="">
				Taxon: 
