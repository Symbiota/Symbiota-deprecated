...
if($specimenArray){
	...
	foreach($specimenArray as $collId => $specData){
        ...
        $recordListHtml .= '<a href="misc/collprofiles.php?collid='.$collId.'">'.$collectionArr[$collId]['name'].'</a>';
        ...
        foreach($specData as $occId => $fieldArr){
            ...
            $recordListHtml .= '<img align="bottom" src="'.$icon.'" style="width:35px;border:0px;" /></a>';
            $recordListHtml .= '<div style="font-weight:bold;font-size:75%;">';
            $recordListHtml .= $instCode1;
            if($instCode2) $recordListHtml .= "<br/>".$instCode2;
