...
$clusterOff = (array_key_exists('clusterSwitch',$_REQUEST)?$_REQUEST['clusterSwitch']:'n');
$recLimit = (array_key_exists('recordlimit',$_REQUEST)&&is_numeric($_REQUEST['recordlimit'])?$_REQUEST['recordlimit']:5000);
...
<head>
	...
	<script type="text/javascript" src="../../js/symb/collections.mapinterface.js?170822"></script>
