...
if(!$SYMB_UID) header('Location: ../../profile/index.php?refurl=../collections/cleaning/fieldcleaner.php?'.$_SERVER['QUERY_STRING']);
...
<body>
	...
	<div class='navpath'>
		...
		<?php 
		if($mode){
			echo '&gt;&gt; <a href="fieldcleaner.php?collid='.$collid.'&mode=0">return to main menu</a>';
		}
		?>
	</div>
	...
	<div id="innertext">
		...
		if($isEditor){
			...
			<fieldset style="padding:20px;position:relative">
				...
				<?php
				if($target == 'geolocal'){ 
					if($mode) echo '<div style="position:absolute;top:5px;right:0px;padding:10px;border:1px solid grey"><a href="fieldcleaner.php?collid='.$collid.'&mode=0">return to main menu</a></div>';
					...
					elseif($mode == 'nullcounty'){
						...
						echo '<div style="margin-bottom:10px"><b>Null country with non-Null state/province:</b> ';
						...
						echo '<div style="margin-bottom:10px"><b>Null state/province with non-Null county:</b> ';
						...
						echo '<div style=""><b>Null county with non-Null locality details:</b> ';
