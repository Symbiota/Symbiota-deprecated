     			...
     			<div key="1">
						<div className="row slide-wrapper slide-1">
							<div className="col-md slide-col-1">
										<h1>Welcome to OregonFlora, the world&rsquo;s most comprehensive guide to the vascular plants of Oregon</h1>
							...
							<h1>Oregon Flora News and Events</h1>
								<div className="row">
										...
										<div className="col-md-6 slide-col-2">
											...
											<p><button className="btn btn-primary"><a href={this.props.clientRoot + '/pages/news-events.php' }>See all news and events</a></button></p>
										</div>    
								</div>
						</div>
					</div>
