...
//     if ((currentScrollPos - prevScrollPos) > 10 && currentScrollPos > 80 && !header.hasClass("site-header-scroll")) {
//       header.addClass("site-header-scroll");
//       collapseSiteLogo(logo);
//     // Is moving upward and past 80px and isn't already expanded
//     } else if ((currentScrollPos - prevScrollPos) < -10 && currentScrollPos < 80 && header.hasClass("site-header-scroll")) {
