...
function openMapPopup(taxonVar,clid){
	var popupMap = window.open('../collections/map/googlemap.php?maptype=taxa&taxon='+taxonVar+'&clid='+clid,'gmap','toolbar=0,scrollbars=1,width=950,height=700,left=20,top=20');
