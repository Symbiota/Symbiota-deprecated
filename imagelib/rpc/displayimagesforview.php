...
include_once($serverRoot.'/classes/PhotographerManager.php');
    ...
    ?>
                    ...
                    <div class="tndiv" style="margin-top: 15px; margin-bottom: 15px">
                        ...
                        <div>
                            <?php echo "<a href=\"../taxa/index.php?taxon=".$imgArr['tid']."\">".$imgArr['sciname']."</a><br />" . $imgArr['stateprovince'] . "<br /><a href=\"#\" onclick=\"openIndPU(".$imgArr['occid'].");\">" . $imgArr['instcode'] . " - " . $imgArr['catalognumber']. "</a>"; ?>
                            </a>
                        </div>
                    </div>
                <?php
